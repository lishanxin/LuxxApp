 ...
 * @date 2015-06-29
 */
public class RemoterListView extends ListView implements OnScrollListener {
	// 释放刷新
	...
	public RemoterListView(Context context) {
		super(context);
		init(context);
	}

	public RemoterListView(Context context, AttributeSet attrs) {
		/**
		 * cy修改自定义控件的实现
		 */
		super(context, attrs);
