...
public class SwipeMenuListView extends ListView {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			if (changeListener != null && mTouchView != null) {
				changeListener.onItemTextChange(mTouchView.getPosition(), mTouchView.getTitleViews());
				changeListener.onItemIconChange(mTouchView.getPosition(), mTouchView.getIconViews());
			}
			if (mTouchView != null) {
				mTouchView.onSwipe(ev);
			}
