...
//	}
	...
	private void setData() {
		if (getIntent() != null
			...
			infor = manager.getPISObject(key);
...
//		adapter = new LightDetailAdapter(this, infor);
//		if (infor instanceof PISxinColor){
//			PISxinColor xc = (PISxinColor)infor;
...
//				Intent it = new Intent(LightSettingActivity.this,
	...
	private void setListViewListener() {
		...
		listView.setOnMenuItemClickListener(new SwipeMenuListView.OnMenuItemClickListener() {
			...
			public boolean onMenuItemClick(final int position, SwipeMenu menu,
				...
				switch (index) {
				case 0:
					PISBase obj = adapter.getGroupObject(position);
					try{
						PipaRequest req;
						PISBase pis;
