...
public class CusPullNewListView extends ListView implements OnScrollListener{
...
//	private static final String TAG = "listview";
	...
	public CusPullNewListView(Context context) {
		super(context);
		init(context);
	}

	public CusPullNewListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
...
//		setCacheColorHint(context.getResources().getColor(R.color.transparent));
	...
	public boolean onTouchEvent(MotionEvent event) {
		Log.i("hxj", "event.getAction()==>"+event.getAction()+" isRefreshable==>"+isRefreshable);
		isTouch=true;
	...
	private void changeHeaderViewByState() {
		...
		case RELEASE_To_REFRESH:
			...
			tipsTextview.setText(getContext().getResources().getString(R.string.refresh_alsert));
	...
	public void onRefreshComplete() {
		...
		lastUpdatedTextView.setText(getContext().getResources().getString(
				R.string.last_refresh_alsert) + new Date().toLocaleString());
		changeHeaderViewByState();
	}
