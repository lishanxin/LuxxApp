 ...
 * @date 2015-06-29
 */
public class SwitcherListView extends ListView implements OnScrollListener {
	// 释放刷新
	...
	public SwitcherListView(Context context) {
		super(context);
		init(context);
	}

	public SwitcherListView(Context context, AttributeSet attrs) {
		/**
		 * cy修改自定义控件的实现
		 */
		super(context, attrs);
